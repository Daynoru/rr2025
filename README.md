...
*Saccharomyces cerevisiae* (пекарские дрожжи) — ключевой модельный эукариотический организм и основной биотехнологический хост, используемый для фундаментальных исследований и производства широкого спектра соединений. Несмотря на обширные данные о реакции дрожжей на различные стрессоры, систематический анализ их транскрипционного ответа на L-лактат — соединение, представляющее как промышленный, так и физиологический интерес, — до сих пор отсутствовал.

Данный репозиторий содержит материалы исследования, в котором впервые проведён детальный анализ изменений в экспрессии генов S. cerevisiae под воздействием 45 мМ L-лактата. Основной целью работы было восполнение этого пробела в данных и выявление специфических черт клеточного ответа на данное соединение.
...
# Анализ дифференциальной экспрессии генов
 ...
 Для количественной оценки экспрессии генов была использована программа featureCounts. Подсчёт ридов, выравненных на аннотированные гены, выполнялся с указанием следующих параметров:
...
Изменение экспрессии проанализированных генов отражает не хаотичную реакцию на стресс, а сложную, многоуровневую и внутренне согласованную адаптивную программу дрожжевой клетки. Эта программа направлена на: 1) нейтрализацию непосредственной угрозы (закисление и окислительный стресс), 2) глобальную экономию ресурсов и 3) перестройку метаболизма для выживания в ущерб росту.
